...
// export const createSettingEntry = async (req, res) => {
//     try {
//       const { setting_person_id, lot_number, date, items } = req.body;
...
//       // Create SettingEntry (linking to first filingItem's casting item)
//       const firstFilingItem = await prisma.filingItems.findUnique({
//         where: { id: filingItemIds[0] },
//         select: { casting_item_id: true },
//       });
...
//           date: date || new Date(),
//           setting_person: { connect: { id: setting_person_id } },
//           castingItem: { connect: { id: firstFilingItem.casting_item_id } },
//         },
//         include: {
//           setting_person: true,
//           filingItems: true,
...
//       });
//     } catch (error) {
//       console.error('Error creating single setting entry for multiple items:', error);
//       return res.status(500).json({
//         error: 'Internal server error',
//         details: error?.message || error,
//       });
...
// export const createSettingEntry = async (req, res) => {
//     try {
//       const { setting_person_id, lot_number, filingItemIds } = req.body;
...
//       // Create SettingEntry — note: casting_item_id is required and unique
//       const settingEntry = await prisma.settingEntry.create({
//         data: {
//           setting_person: { connect: { id: setting_person_id } },
//           // Using the first filingItem's casting_item_id as the castingItem for the entry
//           castingItem: { connect: { id: filingItemIds[0] } },
//         },
//         include: {
//           setting_person: true,
//           filingItems: true,
...
//               lot_id: lot.id,
//               filing_item_id: filingItemId,
//               setting_entry_id: settingEntry.id, // you'll need to add this if not in schema
//             },
//           })
//         )
//       );
...
//       return res.status(201).json({
//         message: 'Single SettingEntry created for multiple filing items successfully',
//         entry: {
//           ...settingEntry,
//           filingItems: fullItems,
//         },
