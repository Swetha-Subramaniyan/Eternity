...
import styles from './FilingDetails.module.css'
...
const FilingDetails = () => {
    ...
    { item: "cst", beforeWeight: "50", touch: "92", purity: "22K" },
    { item: "cst1", beforeWeight: "48", touch: "91", purity: "22K" },
    { item: "cst2", beforeWeight: "55", touch: "90", purity: "22K" }
  ]);
  ...
  return (
    ...
    <Box sx={{ p: 3 }}>
      <div className="top-bar">
        ...
        <div> 
          <Link to='/filingreport'> <button> Filing Report </button> </Link>
        </div>
        <Button 
          sx={{    
            marginLeft: 95,
         ...
         onClick={() => setIsModalOpen(true)}>  Add Filing Items  </Button>
      </div>
...
<Box sx={{ mt: 3 }}>
  ...
  <Button variant="outlined" onClick={handleAddProductItem}>Add Item</Button>
      ...
      {productItems.map((item, index) => (
        <TableRow key={index}>
          ...
          <TableCell>
            <TextField
              value={item.itemName}
              onChange={(e) => handleProductItemChange(index, "itemName", e.target.value)}
              size="small"
            />
          </TableCell>
          <TableCell>
            <TextField
              type="number"
              value={item.weight}
              onChange={(e) => handleProductItemChange(index, "weight", e.target.value)}
              size="small"
            />
          </TableCell>
        </TableRow>
...
<Box sx={{ mt: 3 }}>
  ...
  <Button variant="outlined" onClick={handleAddScrapItem}>Add Scrap Items</Button>
  <Table size="small" sx={{ mt: 1 }}>
    <TableHead>
      <TableRow>
        <TableCell>S.No</TableCell>
      ...
      {scrapItems.map((item, index) => (
        <TableRow key={index}>
          ...
          <TableCell>
            <TextField
              value={item.itemName}
              onChange={(e) => handleScrapItemChange(index, "itemName", e.target.value)}
              size="small"
            />
          </TableCell>
          <TableCell>
            <TextField
              type="number"
              value={item.weight}
              onChange={(e) => handleScrapItemChange(index, "weight", e.target.value)}
              size="small"
            />
          </TableCell>
        </TableRow>
