...
//   const popupData = [
//     { id: 1, item: "cst", weight: "50", touch: "91.7", purity: "22K", remarks: "aaaaaaa" },
//     { id: 2, item: "cst1", weight: "48", touch: "91.7", purity: "22K", remarks: "bbbbbbb" },
//     { id: 3, item: "Chain", weight: "150", touch: "92", purity: "22K", remarks: "cccccccc", stoneWeight: "20", stoneCount: "3" },
//     { id: 4, item: "Ring", weight: "150", touch: "92", purity: "22K", remarks: "dddddddd", stoneWeight: "20", stoneCount: "3" },
//   ];
...
//         // transform to match your UI fields
//         const transformed = filtered.map((item) => ({
//           id: item.id,
//           item: `Item-${item.filing_item_id}`, // you can replace with actual item name if available
//           weight: item.weight,
//           touch: item.touch?.touch || "-",
//           purity: item.item_purity,
//           remarks: item.remarks,
//           stoneCount: item.stoneCount || "-", // not in response, keeping placeholder
//           stoneWeight: item.stoneWeight || "-", // not in response, keeping placeholder
//         }));
