      ...
      <nav className="navbar">
        ...
        <ul className="nav-list">
          ...
          <li className={`nav-item ${isActive("/filing") ? "active" : ""}`}>
            <a href="/filing" className="nav-link">
              Filing
            </a>
          </li>
          ...
          <li className={`nav-item ${isActive("/buffing") ? "active" : ""}`}>
            <a href="/buffing" className="nav-link">
              Buffing
            </a>
          </li>
          ...
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu" aria-labelledby="reportDropdown">
              <li>
                <Link className="dropdown-item" to="/salesreport">
                  Sales Report
                </Link>
              </li>
              <li>
                <Link className="dropdown-item" to="/customerreport">
                  Customer Report
                </Link>
              </li>
              <li>
                <Link className="dropdown-item" to="/stockreport">
                  Stock Report
                </Link>
              </li>
              <li>
                <Link className="dropdown-item" to="/receiptreport">
                  Receipt Report
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link className="dropdown-item" to="/settingreports">
                  Setting Report
                </Link>
              </li>
              <li>
                <Link className="dropdown-item" to="/buffingreports">
                  Buffing Report
                </Link>
              </li>
              <li>
                <Link className="dropdown-item" to="/workerReport">
                  Worker Report
                </Link>
              </li>
            </ul>
